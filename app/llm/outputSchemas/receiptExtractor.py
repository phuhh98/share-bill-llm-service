...
class FormatInstructions(BaseModel):
    """Receipt details"""
    currency: str = Field(description="Short name of currency being used in the bill in ISO 4217 format")
    error: Union[str, None] = Field(description="""
      Error message.
    ...
    receipt_date: datetime.date = Field(description="The issued date of the bill or receipt in ISO 8601 format")
    total_receipt_price: float = Field(description="The bill total price after discount")
